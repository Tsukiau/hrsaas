  ...
  <el-dialog title="新增部门" :visible="showDialog" width="50%">
    ...
    <el-form label-width="120px" :rules="deptRules" :model="formDate">
      ...
      <el-form-item label="部门编码" prop="code">
        <el-select @focus.native="getEmployeeSimple" v-model="formDate.code" style="width:80%" placeholder="1-50个字符">
         <!--   显示的是用户名 存的也是用户名 -->
        <el-option v-for="item in peoples " :key="item.id" :label="item.username" :value="item.">
